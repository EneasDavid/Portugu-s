    ...
    <main>
        ...
        <div class="container">
            <div class="question">
                ...
                <div>
				<h4 style="padding: 2px;font-family: Arial;color: rgb(214 231 252);line-height: 1.47059;font-size: 1.1rem;font-weight: 800;letter-spacing: -.022em;">'eu gostava muito de passeá- saí com as minhas colegas- brincá na porta di casa di vôlei- andá de patins- bicicleta- quando eu levava um tombo ou outro- eu era a::- a palhaça da turma- ((risos))- eu acho que foi uma das fases mais- assim- gostosas da minha vida foi- essa fase de quinze- dos meus treze aos dezessete anos- '</h4>
				<h3 Style="font-size: small;font-style: italic;">A.P.S., sexo feminino, 38 anos, nível de ensino fundamental. Projeto Fala Goiana, UFG, 2010 (inédito).</h3>
				</div>
					<h1 Style="font-size:1rem">Um aspecto da composição estrutural que caracteriza o relato pessoal de A.P.S. como modalidade falada da língua é:</h1>
					<div Style="display: flex;flex-direction: row;justify-content: space-around;">
                    <div id="perguntas">
                    	<div id="pertinencia">
                    		<input type="radio" id="a" name="resposta" value="a" data-resultado="true">
                    		<label for="a">a) predomínio de linguagem informal entrecortada por pausas.</label>
                    	</div>
                    	<div id="pertinencia">
                    		<input type="radio" id="b" name="resposta" value="b">
                    		<label for="a">b) vocabulário regional desconhecido em outras variedades do português.</label>
                    	</div>
                    	<div id="pertinencia">
                    		<input type="radio" id="c" name="resposta" value="c">
                    		<label for="a">c) realização do plural conforme as regras da tradição gramatical.</label>
                    	</div>
                    	<div id="pertinencia">
                    		<input type="radio" id="d" name="resposta" value="d">
                    		<label for="a">d) ausência de elementos promotores de coesão entre os eventos narrados.</label>
                    	</div>
                    	<div id="pertinencia">
                   			<input type="radio" id="e" name="resposta">
                   			<label for="a">e) presença de frases incompreensíveis a um leitor iniciante.</label>
                    	</div>
                    </div>
             ...
             <div id="quantidadeQuestao">
					...
					<div>
						...
						<div id="perQuestao">
							<li><a href="AlunoServlet?acao=questaoQuatorze"><button Style="border-radius: 100px;width: 20px;height: 20px;background: #0a94d5;">14</button></a></li>
