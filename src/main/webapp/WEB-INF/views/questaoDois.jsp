    ...
    <main>
        ...
        <div class="container">
            <div class="question">
				...
				<h4 style="padding: 2px;font-family: Arial;color: rgb(214 231 252);line-height: 1.47059;font-size: 1.1rem;font-weight: 800;letter-spacing: -.022em;">De vez em quando, nas redes sociais, a gente se pega compartilhando notícias falsas,
				 fotos modificadas, boatos de todo tipo. O problema é quando a matéria é falsa. E, pior ainda, se é uma matéria falsa que não foi criada por motivos humorísticos
				 ou literários (sim, considero o 'jornalismo ficcional' uma interessante forma de literatura), mas para prejudicar
				 a imagem de algum partido ou de algum político, não importa de que posição ou tendência. Inventa-se uma arbitrariedade 
				ou falcatrua, joga-se nas redes sociais e aguarda-se o resultado. Nesse caso, a multiplicação da notícia falsa 
				(que está sempre sujeita a ser denunciada juridicamente como injúria, calúnia ou difamação) se dá em várias direções.
				 ...
				 <h3 Style="font-size: small;font-style: italic;">Disponível em: http://revistaiiqb.usac.edu.gt. Acesso em: 25 abr. 2018 (adaptado).</h3>
					...
					<h1 Style="font-size:1rem">O texto expõe a preocupação de uma leitora de notícias on-line de que o compartilhamento de conteúdos falsos pode ter como consequência a:</h1>
					<div Style="display: flex;flex-direction: row;justify-content: space-around;">
                    <div id="perguntas">
                    	<div id="pertinencia">
                    		<input type="radio" id="a" name="resposta" value="a">
                    		<label for="a">a) displicência natural das pessoas que navegam pela internet.</label>
                    	</div>
                    	<div id="pertinencia">
                    		<input type="radio" id="b" name="resposta" value="b" data-resultado="true">
                    		<label for="a">b) desconstrução das relações entre jornalismo e literatura.</label>
                    	</div>
                    	<div id="pertinencia">
                    		<input type="radio" id="c" name="resposta" value="c">
                    		<label for="a">c) impossibilidade de identificação da origem dos textos.</label>
                    	</div>
                    	<div id="pertinencia">
                    		<input type="radio" id="d" name="resposta" value="d" data-resultado="true">
                    		<label for="a">d) disseminação de ações criminosas na internet.</label>
                    	</div>
                    	<div id="pertinencia">
                   			<input type="radio" id="e" name="resposta">
                   			<label for="a">e) obtenção de maior popularidade nas redes.</label>
                    	</div>
                    </div>
