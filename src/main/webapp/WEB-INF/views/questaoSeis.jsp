        ...
        <div class="container">
            <div class="question">
                ...
                <div Style="display: flex;flex-direction: column;align-items: center;margin-right: 5px;">
                	<img Style="height: 30rem;" src="Img/QuestaoSeis.png" alt="">
                	<h3 Style="font-size: small;font-style: italic;">ROSA, R. Grande sertão veredas: adaptação da obra de João Guimarães Rosa. São Paulo: Globo, 2014 (adaptado).</h3>
                </div>
                <div>
				<h4 style="padding: 2px;font-family: Arial;color: rgb(214 231 252);line-height: 1.47059;font-size: 1.1rem;font-weight: 800;letter-spacing: -.022em;">A imagem integra uma adaptação em quadrinhos da obra Grande sertão veredas, de Guimarães Rosa. Na representação gráfica, a interrelação de diferentes linguagens caracteriza-se por:</h4>
				<div Style="display: flex;flex-direction: row;justify-content: space-around;">
                    <div id="perguntas">
                    	<div id="pertinencia">
                    		<input type="radio" id="a" name="resposta" value="a">
                    		<label for="a">a) Romper com a linearidade das ações da narrativa literária.</label>
                    	</div>
                    	<div id="pertinencia">
                    		<input type="radio" id="b" name="resposta" value="b">
                    		<label for="a">b) Ilustrar de modo fidedigno passagens representativas da história.</label>
                    	</div>
                    	<div id="pertinencia">
                    		<input type="radio" id="c" name="resposta" value="c">
                    		<label for="a">c) Articular a tensão do romance à desproporcionalidade das formas.</label>
                    	</div>
                    	<div id="pertinencia">
                    		<input type="radio" id="d" name="resposta" value="d" data-resultado="true">
                    		<label for="a">d) Potencializar a dramaticidade do episódio com recursos das artes visuais.</label>
                    	</div>
                    	<div id="pertinencia">
                   			<input type="radio" id="e" name="resposta">
                   			<label for="a">e) Desconstruir a diagramação do texto literário pelo desequilíbrio da composição.</label>
                    	</div>
                    </div>
             ...
             <div id="quantidadeQuestao">
	                ...
	                <div>
                		...
                		<div id="perQuestao">
                			...
                			<li><a href="AlunoServlet?acao=questaoSeis"><button Style="border-radius: 100px;width: 20px;height: 20px;background: #0a94d5;">06</button></a></li>
                		</div>
