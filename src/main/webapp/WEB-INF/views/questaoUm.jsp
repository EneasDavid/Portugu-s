        ...
        <div class="container">
            <div class="question">
                ...
                <div Style="display: flex;flex-direction: column;align-items: center;margin-right: 5px;s">
                	...
                	<h3 Style="font-size: small;font-style: italic;">Disponível em: http://revistaiiqb.usac.edu.gt. Acesso em: 25 abr. 2018 (adaptado).</h3>
                </div>
                <div>
				<h4 style="padding: 2px;font-family: Arial;color: rgb(214 231 252);line-height: 1.47059;font-size: 1.1rem;font-weight: 800;letter-spacing: -.022em;">TEXTO II
					Imaginemos um cidadão, residente na periferia de um grande centro urbano, que diariamente acorda às
					 5h para trabalhar, enfrenta em média 2 horas de transporte público, em geral lotado, para chegar às 
					 8h ao trabalho. Termina o expediente às 17h e chega em casa às 19h para, aí sim, cuidar dos afazeres 
					 domésticos, dos filhos etc. Como dizer a essa pessoa que ela deve praticar exercícios, pois é importante
					  para sua saúde? Como ela irá entender a mensagem da importância do exercício físico? A probabilidade de 
					  essa pessoa praticar exercícios regularmente é significativamente menor que a de pessoas da classe média/
					  alta que vivem outra realidade. Nesse caso, a abordagem individual do problema tende a fazer com que a 
					  pessoa se sinta impotente em não conseguir praticar exercícios e, consequentemente, culpada pelo fato de 
					  ser ou estar sedentária. FERREIRA, M. S. Aptidão física e saúde na educação física escolar: ampliando o enfoque.
