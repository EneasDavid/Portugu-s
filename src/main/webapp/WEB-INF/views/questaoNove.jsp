    ...
    <main>
        ...
        <div class="container">
            <div class="question">
                <form method="POST" id="awnser">
                	<h4 style="padding: 2px;font-family: Arial;color: rgb(214 231 252);line-height: 1.47059;font-size: 1.1rem;font-weight: 800;letter-spacing: -.022em;">Até quando?</h4>
					<h4 style="padding: 2px;font-family: Arial;color: rgb(214 231 252);line-height: 1.47059;font-size: 1.1rem;font-weight: 800;letter-spacing: -.022em;">Não adianta olhar pro céu </h4>
					<h4 style="padding: 2px;font-family: Arial;color: rgb(214 231 252);line-height: 1.47059;font-size: 1.1rem;font-weight: 800;letter-spacing: -.022em;">Com muita fé e pouca luta </h4>
					<h4 style="padding: 2px;font-family: Arial;color: rgb(214 231 252);line-height: 1.47059;font-size: 1.1rem;font-weight: 800;letter-spacing: -.022em;">Levanta aí que você tem muito protesto pra fazer </h4>
					<h4 style="padding: 2px;font-family: Arial;color: rgb(214 231 252);line-height: 1.47059;font-size: 1.1rem;font-weight: 800;letter-spacing: -.022em;">E muita greve, você pode, você deve, pode crer</h4> 
					<h4 style="padding: 2px;font-family: Arial;color: rgb(214 231 252);line-height: 1.47059;font-size: 1.1rem;font-weight: 800;letter-spacing: -.022em;">Não adianta olhar pro chão </h4>
					<h4 style="padding: 2px;font-family: Arial;color: rgb(214 231 252);line-height: 1.47059;font-size: 1.1rem;font-weight: 800;letter-spacing: -.022em;">Virar a cara pra não ver </h4>
					<h4 style="padding: 2px;font-family: Arial;color: rgb(214 231 252);line-height: 1.47059;font-size: 1.1rem;font-weight: 800;letter-spacing: -.022em;">Se liga aí que te botaram numa cruz e só porque Jesus</h4> 
					<h4 style="padding: 2px;font-family: Arial;color: rgb(214 231 252);line-height: 1.47059;font-size: 1.1rem;font-weight: 800;letter-spacing: -.022em;">Sofreu não quer dizer que você tenha que sofrer!</h4>
					<h4 style="padding: 2px;font-family: Arial;color: rgb(214 231 252);line-height: 1.47059;font-size: 1.1rem;font-weight: 800;letter-spacing: -.022em;">GABRIEL, O PENSADOR. Seja você mesmo (mas não seja sempre o mesmo).</h4>
                	<h3 Style="font-size: small;font-style: italic;">Rio de Janeiro: Sony Music, 2001 (fragmento).</h3>
					<h1 Style="font-size:1rem">As escolhas linguísticas feitas pelo autor conferem ao texto:</h1>
					<div Style="display: flex;flex-direction: row;justify-content: space-around;">
                    <div id="perguntas">
                    	<div id="pertinencia">
                    		<input type="radio" id="a" name="resposta" value="a">
                    		<label for="a">a) medicalizada, que relaciona a prática de exercícios físicos por qualquer indivíduo à promoção da saúde.</label>
                    	</div>
                    	<div id="pertinencia">
                    		<input type="radio" id="b" name="resposta" value="b">
                    		<label for="a">b) ampliada, que considera aspectos sociais intervenientes na prática de exercícios no cotidiano.</label>
                    	</div>
                    	<div id="pertinencia">
                    		<input type="radio" id="c" name="resposta" value="c">
                    		<label for="a">c) crítica, que associa a interferência das tarefas da casa ao sedentarismo do indivíduo.</label>
                    	</div>
                    	<div id="pertinencia">
                    		<input type="radio" id="d" name="resposta" value="d" data-resultado="true">
                    		<label for="a">d) focalizada, que atribui ao indivíduo a responsabilidade pela prevenção de doenças.</label>
                    	</div>
                    	<div id="pertinencia">
                   			<input type="radio" id="e" name="resposta">
                   			<label for="a">e) geracional, que preconiza a representação do culto à jovialidade.</label>
                    	</div>
                    </div>
        ...
        <script type="text/javascript">
    					...
    					$("#validar").click(function(){
    	  	 					 $("#comentario").append("<label>Típica do rap, a linguagem coloquial é responsável por conferir o efeito de espontaneidade à letra da música. A linguagem coloquial está associada a um contexto informal de comunicação, portanto, a intenção da música foi reproduzir essa comunicação.</label>");
    								});
								 })
					    </script>
    </main>
