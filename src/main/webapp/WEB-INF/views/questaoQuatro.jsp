        ...
        <div class="container">
            <div class="question">
                ...
                <div Style="display: flex;flex-direction: column;align-items: flex-end;margin-right: 5px;">
                	<img src="Img/QuestaoQuatro.png" alt="">
                </div>
                	<div>
                    ...
                    <div id="perguntas">
                    	<div id="pertinencia">
                    		...
                    		<label for="a">a)Criticar as difíceis condições de vida dos refugiados.</label>
                    	</div>
                    	<div id="pertinencia">
                    		<input type="radio" id="b" name="resposta" value="b">
                    		<label for="a">b) Revelar a longa trajetória percorrida pelos refugiados.</label>
                    	</div>
                    	<div id="pertinencia">
                    		<input type="radio" id="c" name="resposta" value="c">
                    		<label for="a">c) Incentivar a campanha de doações para os refugiados.</label>
                    	</div>
                    	<div id="pertinencia">
                    		<input type="radio" id="d" name="resposta" value="d">
                    		<label for="a">d) Denunciar a situação de carência vivida pelos refugiados.</label>
                    	</div>
                    	<div id="pertinencia">
                   			<input type="radio" id="e" name="resposta" data-resultado="true">
                   			<label for="a">e) Simbolizar a necessidade de adesão à causa dos refugiados.</label>
                    	</div>
                    </div>
             ...
             <div id="quantidadeQuestao">
	                ...
	                <div>
                		...
                		<div id="perQuestao">
                			<li><a href="AlunoServlet?acao=questaoQuatro"><button Style="border-radius: 100px;width: 20px;height: 20px;background: #0a94d5;">04</button></a></li>
					...
					<div>
						...
						<div id="perQuestao">
							...
							<li><a href="AlunoServlet?acao=questaoDezenove"><button Style="border-radius: 100px;width: 20px;height: 20px;">19</button></a></li>
						</div>
					</div>
                	</ul>
                </div>
